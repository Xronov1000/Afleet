...
class FriendMessXnew1 extends StatefulWidget {
  ...
  @override
  State<FriendMessXnew1> createState() => _FriendMessXnew1State();
}

class _FriendMessXnew1State extends State<FriendMessXnew1> {
  var now;
  var leo;
  String xrx = '0';
  var indx;
  ...
  von2x(String ry) {
    var ft = chatdata
        .where((u) =>
            u['title'].contains('message') && u['whoiswho'] == ry.toString())
        .last['id']
        .toString();
    print(ft);
...
chatdata2.map((ex) => ex['useryou'].toString().contains(widget.user.toString())
  ...
  tatuseen() async {
    http.Response response1 = await http.post(
      ...
      body: jsonEncode(<String, String>{
        'username1': widget.user,
        'image': von2x(widget.user)
      }),
    );
  ...
  void initState() {
    ...
    offnd();
    /*if (widget.repl != 'k' && chatdata != null) {
      chatdata = widget.newc;
      pinned = true;
      print(widget.repl);
      indx = int.parse(widget.repl);
      print(">>>>......................" + indx.toString());
    }*/
      ...
      appBar: AppBar(
          actions: [
            /*Container(child:
                            ...
                            Stack(children:[...widget.profpic.map(
                            (ui) =>
                                ui['username1'] == widget.user.toString()
                                    ? Center(
                                        //bottom:0,
                                        child: CircleAvatar(
                                          radius: 20,
...
//                                              : Container(),
          ...
          Row(children: <Widget>[
            ...
            widget.user == "exampleuser"?   InkWell(
              onTap:(){
