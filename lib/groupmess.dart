...
class FriendMess2 extends StatefulWidget {
  ...
  @override
  State<FriendMess2> createState() => _FriendMess2State();
}

class _FriendMess2State extends State<FriendMess2> {
  var now;
  var leo;
  String xrx = '0';
  var indx;
