...
class cal extends StatefulWidget {
   cal({Key? key, required this.username, required this.kala1})
      : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  ListTile(
                    title: Center(
                        child: Text('School Bus:',
                            style: TextStyle(fontSize: 20,color:!widget.kala1
                                  ? Colors.black
                                  : Colors.white,))),
                  ),
                  ListTile(
                  ...
                  ListTile(
                    title: Center(
                        child:
                            Text('Bus Stage:', style: TextStyle(fontSize: 20,color: !widget.kala1
                                  ? Colors.black
                                  : Colors.white,))),
                  ),
                  ListTile(
